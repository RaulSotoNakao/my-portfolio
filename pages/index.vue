...
<template>
  <PageWrapper class="flex-1 flex">
    <div class="background-overlay">
      <div
        class="absolute top-0 left-0 transform translate-x-100 translate-y-4 h-14 w-14 rounded-full bg-gray-900 dark:bg-white"
      ></div>
      <div
        class="absolute hidden md:block top-0 left-0 transform translate-x-120 translate-y-20 h-28 w-28 rounded-full bg-blue-600 linear-wipe"
      ></div>
      <div
        class="absolute hidden md:block bottom-0 right-0 transform -translate-x-180 -translate-y-40 h-16 w-16 rounded bg-purple-600 linear-wipe"
      ></div>

      <div class="absolute bottom-0 right-90 triangle-shape rounded"></div>
    </div>
        ...
        <div class="hidden md:flex md:w-3/8 justify-center items-end relative">
          <div class="ml-4 w-100 z-10 h-auto shadow">
            ...
            >
              ...
              <div class="flex-1 font-bold text-center pr-12 text-sm"></div>
            </div>
            <div
            ...
            >
              <div class="flex justify-center">
                <img class="h-90 rounded" src="~/assets/me.jpg" />
              </div>
            </div>
          </div>
        </div>
